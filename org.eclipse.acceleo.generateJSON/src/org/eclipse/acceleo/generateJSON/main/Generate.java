 ...
 *******************************************************************************/
package org.eclipse.acceleo.generateJSON.main;
...
public class Generate extends AbstractAcceleoGenerator {
	static {
		StoryboardPackage.eINSTANCE.eClass();
	}
    /**
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/eclipse/acceleo/generateJSON/main/generate";
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "generateStoryboard" };
    ...
    public void registerResourceFactories(ResourceSet resourceSet) {
        ...
        resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put(
            "storyboard", // 你的模型文件扩展名
            new XMIResourceFactoryImpl() {
                @Override
                public Resource createResource(URI uri) {
                    XMIResource resource = new XMIResourceImpl(uri);
                    // 启用UUIDs用于跨模型引用
                    resource.getDefaultSaveOptions().put(XMIResource.OPTION_USE_XMI_TYPE, Boolean.TRUE);
                    return resource;
                }
            }
        );
        
        // 注册EPackage到全局注册表（双重保险）
        EPackage.Registry.INSTANCE.put(
            StoryboardPackage.eINSTANCE.getNsURI(), 
            StoryboardPackage.eINSTANCE
        );        
        /*
         * If you want to change the content of this method, do NOT forget to change the "@generated"
         * tag in the Javadoc of this method to "@generated NOT". Without this new tag, any compilation
